...
parser.add_argument('--train_annotations_dir', type=str, default='../data/aircraft_dataset_yolov5.v1i.tensorflow/train/_annotations.txt', help='train annotations path')

parser.add_argument('--test_annotations_dir', type=str, default='../data/aircraft_dataset_yolov5.v1i.tensorflow/valid/_annotations.txt', help='test annotations path')
parser.add_argument('--class_name_dir', type=str, default='../data/aircraft_dataset_yolov5.v1i.tensorflow/aircraft.names', help='classes name path')

parser.add_argument('--train_dir', type=str, default='/Users/skasmani/GithubRepo/tf-yolo/data/aircraft_dataset_yolov5.v1i.tensorflow/train/', help='train annotations path')
parser.add_argument('--valid_dir', type=str, default='/Users/skasmani/GithubRepo/tf-yolo/data/aircraft_dataset_yolov5.v1i.tensorflow/valid/', help='train annotations path')


parser.add_argument('--yaml_dir', type=str, default='/Users/skasmani/GithubRepo/tf-yolo/yolo/configs/yolo-m-mish.yaml', help='model.yaml path')
...
parser.add_argument('--augment_data', type=bool, default=False, help='if augment data')
